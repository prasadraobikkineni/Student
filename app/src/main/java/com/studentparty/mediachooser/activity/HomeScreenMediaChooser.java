package com.studentparty.mediachooser.activity;
...
import com.studentparty.mediachooser.adapter.ViewPagerAdapter;
import com.studentparty.mediachooser.fragment.BucketImageFragment;
import com.studentparty.mediachooser.fragment.BucketVideoFragment;
import com.studentparty.mediachooser.fragment.ImageFragment;
import com.studentparty.mediachooser.fragment.VideoFragment;
...
public class HomeScreenMediaChooser extends BaseActivity implements ImageFragment.OnImageSelectedListener, VideoFragment.OnVideoSelectedListener {
    ...
    private String[] permissionArray={Manifest.permission.CAMERA};
        ...
        public void onClick(View view) {
            if (view == mCameraVideo) {
                ...
                if (view.getTag() != null) {
                   ...
                   callPermission(view.getTag().toString());
                }
            } else if (view == mDone) {
...
private  void  callPermission(final String type)
{
    requestPermissions(permissionArray, new PermissionCallBack() {
        @Override
        public void permissionGranted() {
            if (type.equals(getResources().getString(R.string.video))) {
