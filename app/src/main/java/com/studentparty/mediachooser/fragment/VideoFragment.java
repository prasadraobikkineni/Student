...
import com.studentparty.mediachooser.Utilities.MediaModel;
import com.studentparty.mediachooser.adapter.GridViewAdapter;
    ...
    private void setAdapter() {
        ...
        mVideoGridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                GridViewAdapter adapter = (GridViewAdapter) parent.getAdapter();
                MediaModel galleryModel = adapter.getItem(position);
                MediaChooserConstants.VIDEO_ALREADY_SELCTED=true;
                ...
                if (!galleryModel.status) {
                    ...
                    if(MediaChooserConstants.IMAGE_ALREADY_SELCTED)
                    {
                        Toast.makeText(getActivity(), getActivity().getResources().getString(R.string.image_validation), Toast.LENGTH_SHORT).show();
                        return;
                    }
